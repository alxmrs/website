...
![My site does not use HTTPS, and therefore is not secure](assets/alex-is-not-secure.webp "A URL bar with no HTTPS support")
...
![I have to wait on a text to a phone number I don't control](assets/namecheap-mfa-masked.webp
...
context to correctly model risk. At the time, I didn't know of the importance of certain choices -- like how [important HTTPS is for web browsing](https://doesmysiteneedhttps.com/). I also 
